    ...
    L.Polyline.include({
        ...
        updateMeasurements: function() {
            ...
            if (this._measurementOptions.showDistances && latLngs.length > 1) {
                ...
                for (var i = 1, len = latLngs.length; (isPolygon && i <= len)="" ||="" i="" <="" len;="" i++)="" {="" ll1="latLngs[i" -="" 1];="" ll2="latLngs[i" %="" len];="" dist="ll1.distanceTo(ll2);" totaldist="" +="dist;" p1="this._map.latLngToLayerPoint(ll1);" p2="this._map.latLngToLayerPoint(ll2);" pixeldist="p1.distanceTo(p2);" if="" (pixeldist="">= options.minPixelDistance) {
