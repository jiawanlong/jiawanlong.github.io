import{_ as a,c as n,a0 as p,o as e}from"./chunks/framework.wfMVytlW.js";const b=JSON.parse('{"title":"Scss语法","description":"","frontmatter":{},"headers":[],"relativePath":"css/Scss语法.md","filePath":"css/Scss语法.md"}'),l={name:"css/Scss语法.md"};function i(c,s,o,t,r,d){return e(),n("div",null,s[0]||(s[0]=[p(`<h1 id="scss语法" tabindex="-1">Scss语法 <a class="header-anchor" href="#scss语法" aria-label="Permalink to &quot;Scss语法&quot;">​</a></h1><h2 id="_1、定义和使用变量" tabindex="-1">1、定义和使用变量 <a class="header-anchor" href="#_1、定义和使用变量" aria-label="Permalink to &quot;1、定义和使用变量&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>$primary-color: #333;</span></span>
