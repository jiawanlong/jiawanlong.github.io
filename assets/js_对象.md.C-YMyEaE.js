import{_ as s,c as n,a0 as e,o as p}from"./chunks/framework.BYlfzdEH.js";const u=JSON.parse('{"title":"对象","description":"","frontmatter":{},"headers":[],"relativePath":"js/对象.md","filePath":"js/对象.md"}'),t={name:"js/对象.md"};function l(i,a,o,c,r,d){return p(),n("div",null,a[0]||(a[0]=[e(`<h1 id="对象" tabindex="-1">对象 <a class="header-anchor" href="#对象" aria-label="Permalink to &quot;对象&quot;">​</a></h1><h2 id="_1、对象字面量" tabindex="-1">1、对象字面量 <a class="header-anchor" href="#_1、对象字面量" aria-label="Permalink to &quot;1、对象字面量&quot;">​</a></h2><h3 id="_1-1、属性的简洁表示法" tabindex="-1">1.1、属性的简洁表示法 <a class="header-anchor" href="#_1-1、属性的简洁表示法" aria-label="Permalink to &quot;1.1、属性的简洁表示法&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>const age = 12;</span></span>
