import{_ as n,c as a,a0 as p,o as e}from"./chunks/framework.BYlfzdEH.js";const h=JSON.parse('{"title":"组件通讯","description":"","frontmatter":{},"headers":[],"relativePath":"vue2/vuex.md","filePath":"vue2/vuex.md"}'),t={name:"vue2/vuex.md"};function l(i,s,o,c,r,u){return e(),a("div",null,s[0]||(s[0]=[p(`<h1 id="组件通讯" tabindex="-1">组件通讯 <a class="header-anchor" href="#组件通讯" aria-label="Permalink to &quot;组件通讯&quot;">​</a></h1><h2 id="_1、文件存放" tabindex="-1">1、文件存放 <a class="header-anchor" href="#_1、文件存放" aria-label="Permalink to &quot;1、文件存放&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>└── store</span></span>
