import{_ as n,c as a,a0 as t,o as p}from"./chunks/framework.wfMVytlW.js";const g=JSON.parse('{"title":"伪类、伪元素","description":"","frontmatter":{},"headers":[],"relativePath":"css/伪类、伪元素.md","filePath":"css/伪类、伪元素.md"}'),l={name:"css/伪类、伪元素.md"};function e(i,s,c,o,r,d){return p(),a("div",null,s[0]||(s[0]=[t(`<h1 id="伪类、伪元素" tabindex="-1">伪类、伪元素 <a class="header-anchor" href="#伪类、伪元素" aria-label="Permalink to &quot;伪类、伪元素&quot;">​</a></h1><h2 id="_1、伪元素" tabindex="-1">1、伪元素 <a class="header-anchor" href="#_1、伪元素" aria-label="Permalink to &quot;1、伪元素&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>::after	    p::after	               在每个 &lt;p&gt; 元素之后插入内容。</span></span>
