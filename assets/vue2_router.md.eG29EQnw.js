import{_ as a,c as n,a0 as p,o as e}from"./chunks/framework.wfMVytlW.js";const d=JSON.parse('{"title":"路由","description":"","frontmatter":{},"headers":[],"relativePath":"vue2/router.md","filePath":"vue2/router.md"}'),l={name:"vue2/router.md"};function i(t,s,o,c,r,u){return e(),n("div",null,s[0]||(s[0]=[p(`<h1 id="路由" tabindex="-1">路由 <a class="header-anchor" href="#路由" aria-label="Permalink to &quot;路由&quot;">​</a></h1><h2 id="_1、脚手架生成框架" tabindex="-1">1、脚手架生成框架 <a class="header-anchor" href="#_1、脚手架生成框架" aria-label="Permalink to &quot;1、脚手架生成框架&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>//index.js</span></span>
