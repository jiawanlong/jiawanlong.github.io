import{_ as a,c as s,a0 as p,o as e}from"./chunks/framework.BYlfzdEH.js";const h=JSON.parse('{"title":"Proxy","description":"","frontmatter":{},"headers":[],"relativePath":"js/Proxy.md","filePath":"js/Proxy.md"}'),l={name:"js/Proxy.md"};function t(i,n,o,c,r,d){return e(),s("div",null,n[0]||(n[0]=[p(`<h1 id="proxy" tabindex="-1">Proxy <a class="header-anchor" href="#proxy" aria-label="Permalink to &quot;Proxy&quot;">​</a></h1><p>代理器: 在目标对象之前架设一层&quot;拦截&quot;，外界对该对象的访问，都必须先通过这层拦截 。</p><h2 id="_1、get-方法" tabindex="-1">1、get()方法 <a class="header-anchor" href="#_1、get-方法" aria-label="Permalink to &quot;1、get()方法&quot;">​</a></h2><p>get方法是用于拦截某个属性的读取操作，可以接受三个参数，依次为 target:目标对象；prop:属性名； proxy实例本身 (操作行为所针对的对象)，最后一个参数可选</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>var person ={</span></span>
