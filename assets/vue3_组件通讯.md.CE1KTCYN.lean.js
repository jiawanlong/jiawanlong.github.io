import{_ as a,c as s,a0 as p,o as t}from"./chunks/framework.BYlfzdEH.js";const m=JSON.parse('{"title":"组件通讯","description":"","frontmatter":{},"headers":[],"relativePath":"vue3/组件通讯.md","filePath":"vue3/组件通讯.md"}'),e={name:"vue3/组件通讯.md"};function l(i,n,c,o,r,d){return t(),s("div",null,n[0]||(n[0]=[p(`<h1 id="组件通讯" tabindex="-1">组件通讯 <a class="header-anchor" href="#组件通讯" aria-label="Permalink to &quot;组件通讯&quot;">​</a></h1><ul><li>props/$emit</li><li>vuex/pinia</li><li>provide/inject</li><li>mitt</li></ul><h2 id="_1、props-emits" tabindex="-1">1、Props / Emits <a class="header-anchor" href="#_1、props-emits" aria-label="Permalink to &quot;1、Props / Emits&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// Parent.vue</span></span>
